...
public class main {
    ...
    public static void main(String[] args) throws SQLException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
    	...
    	System.out.println("Souhaitez vous accedez � l'affichage textuel (question 9) [t] ou � l'affichage graphiques (questions 10 et 11) [g] ?");
    	answer = reader.next();
    	
    	if (answer.equalsIgnoreCase("t")) {
    		System.out.println("Question 9 :");
    		System.out.println("Entrez une chaine de caract�re, ou [d] pour utiliser celle par d�faut (Dom__ne _niversit%)");
    		answer = reader.next();
    		...
    		System.out.println("Noms et coordonn�es g�ographiques des points dont le nom ressemble � " + answer + " :");
    		...
    		while(continuer && !displayable.isEmpty()) {
    			System.out.println("Op�ration(s) termin�e(s)");
    			System.out.println("Souhaitez vous ajouter des �l�ments � la carte ? [y/exit]");
    			answer = reader.next();
